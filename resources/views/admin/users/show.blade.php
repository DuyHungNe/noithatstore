...
@section('title', 'Chi Tiêt Ngôi Dùng')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Chi Tiêt Ngôi Dùng</h1>
            <div class="space-x-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        <span class="font-medium text-gray-600">Hô và Tên:</span>
                    ...
                    <div>
                        <span class="font-medium text-gray-600">Ðiên Thoai:</span>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div>
                        <span class="font-medium text-gray-600">Ðiâ Chi:</span>
                ...
                @if($user->orders->count() > 5)
                    <div class="mt-4 text-center">
                        <a href="{{ route('admin.orders.index') }}?user_id={{ $user->id }}" class="text-blue-600 hover:text-blue-800">
                            Xem tât ca {{ $user->orders->count() }} Ðôn hàng
                        </a>
                    </div>
                @endif
            </div>
