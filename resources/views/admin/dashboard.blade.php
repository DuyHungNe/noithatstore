...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm text-gray-600">Tông Ngôi Dùng</p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm text-gray-600">Tông Sân Phâm</p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm text-gray-600">Danh Muc</p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm text-gray-600">Tông Ðôn Hàng</p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    <!-- Order Stats -->
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold mb-4">Thông Kê Ðôn Hàng</h3>
        <div class="space-y-4">
            <div class="flex justify-between items-center">
                <span class="text-gray-600">Ðôn Hàng Chô Xû Lý</span>
                <span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-semibold">
                    {{ $stats['pending_orders'] }}
                </span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-gray-600">Ðôn Hàng Hoàn Thành</span>
                <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">
                    {{ $stats['completed_orders'] }}
                </span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-gray-600">Tông Doanh Thu</span>
    ...
    <!-- Quick Actions -->
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold mb-4">Hành Ðông Nhanh</h3>
...
<div class="bg-white rounded-lg shadow p-6 mb-8">
    <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold">Ðôn Hàng Gân Ðây</h3>
        <a href="/admin/orders" class="text-blue-600 hover:text-blue-800">Xem Tât Ca</a>
    </div>
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Mã Ðôn</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Khách Hàng</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tông Tiên</th>
...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold">Sân Phâm Bán Chây</h3>
        <a href="/admin/products" class="text-blue-600 hover:text-blue-800">Xem Tât Ca</a>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        @foreach($topProducts as $product)
            <div class="text-center">
                ...
                <p class="text-xs text-gray-600">{{ $product->order_items_count }} Ðôn hàng</p>
            </div>
        @endforeach
    </div>
</div>
