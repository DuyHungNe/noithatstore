...
@section('title', 'Chi Tiêt Danh Muc')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Chi Tiêt Danh Muc</h1>
            <div class="space-x-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                <h2 class="text-lg font-semibold text-gray-700 mb-4">Thông Tin Danh Muc</h2>
                <div class="space-y-3">
                    <div>
                    ...
                    <div>
                        <span class="font-medium text-gray-600">Tên Danh Muc:</span>
                    ...
                    <div>
                        ...
                        <span class="ml-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            ...
                            {{ $category->is_active ? 'Hoat Ðông' : 'Khoa' }}
                        </span>
                    </div>
                    <div>
                        <span class="font-medium text-gray-600">Sô Luring Sân Phâm:</span>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div>
                        <span class="font-medium text-gray-600">Mô Tã:</span>
                        <div class="text-gray-900 ml-2 mt-1">{{ $category->description ?: 'Chua có mô tã' }}</div>
                    </div>
                    @if($category->image)
                        <div>
                            <span class="font-medium text-gray-600">Hình Anh:</span>
                            <div class="mt-2">
                    ...
                    @endif
                    <div>
                        <span class="font-medium text-gray-600">Ngày Tao:</span>
                        <span class="text-gray-900 ml-2">{{ $category->created_at->format('d/m/Y H:i') }}</span>
                    </div>
                    <div>
                        <span class="font-medium text-gray-600">Câp Nhât Cuôi:</span>
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Mã Sân Phâm</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tên Sân Phâm</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Gia</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tôn Kho</th>
                            </tr>
                        </thead>
                ...
                @if($category->products->count() > 10)
                    <div class="mt-4 text-center">
                        <a href="{{ route('admin.products.index') }}?category_id={{ $category->id }}" class="text-blue-600 hover:text-blue-800">
                            Xem tât ca {{ $category->products->count() }} sân phâm
                        </a>
                    </div>
                @endif
            </div>
        @else
            <div class="mt-8">
                ...
                <div class="bg-gray-50 rounded-lg p-8 text-center text-gray-500">
                    Chua có sân phâm nào trong danh mûc này
                </div>
            </div>
        @endif
    </div>
