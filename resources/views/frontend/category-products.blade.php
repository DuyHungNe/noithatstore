    ...
    <div class="max-w-7xl mx-auto px-4">
        @if($products->count() > 0)
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-2xl font-bold text-gray-800">{{ $products->count() }} Sân Phâm Trong Danh Muc</h2>
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Không Có Sân Phâm Nào</h3>
                <p class="text-gray-500">Hiên tai không có sân phâm nào trong danh mûc "{{ $category->name }}".</p>
