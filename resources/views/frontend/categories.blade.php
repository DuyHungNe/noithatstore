...
@section('title', 'Danh Muc Sân Phâm')

@section('content')
<!-- Hero Section -->
<section class="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <h1 class="text-3xl md:text-4xl font-bold mb-4">Danh Muc Sân Phâm</h1>
        <p class="text-xl">Khám phá các danh mûc nôi thât cao câp cûa chúng tôi</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition group cursor-pointer" onclick="window.location.href='/category/{{ $category->id }}'">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500">{{ $category->products_count ?? $category->products->count() }} sân phâm</span>
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Chua Có Danh Muc Nào</h3>
                <p class="text-gray-500">Hiên tai không có danh mûc nào available.</p>
            </div>
        @endif
    </div>
</section>
